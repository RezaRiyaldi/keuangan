			...
			<div class="authentication-inner">
				...
				<div class="card">
					<div class="card-body">
						...
						<p class="mb-4 text-center">Mohon masukan username dan password untuk masuk ke halaman utama</p>

						<form id="formAuthentication" class="mb-3" action="" method="POST">
							<div class="mb-3">
								<label for="username" class="form-label">Username</label>
								<input type="text" class="form-control" id="username" name="username" placeholder="Masukan username anda" autofocus value="<?= set_value('username') ?>" />
